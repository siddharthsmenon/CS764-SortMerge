...
using boost::simd::detail::input_begin;
using boost::simd::detail::output_begin;
...
{
    return make_tuple(boost::simd::min(a, b), boost::simd::max(a, b));
}
...
transpose4(simd_type a, simd_type b, simd_type c, simd_type d)
{
    ...
    simd_type x = boost::simd::interleave_first(a, b);
    simd_type y = boost::simd::interleave_second(a, b);
    simd_type z = boost::simd::interleave_first(c, d);
    simd_type w = boost::simd::	interleave_second(c, d);
